...
var Element = function () {
    ...
    Element.prototype.setX = function setX(x) {
        this.x = x;
    };

    Element.prototype.setY = function setY(y) {
        this.y = y;
    };
...
var Portal = function (_Element) {
    _inherits(Portal, _Element);

    function Portal(img, x, y, width, height) {
        _classCallCheck(this, Portal);

        var _this = _possibleConstructorReturn(this, _Element.call(this, x, y, width, height));

        _this.img = new Sprite(img, 2483, 329, 670, 670);
        _this.speed = 0.2;
    ...
    Portal.prototype.move = function move() {
    ...
    Portal.prototype.setScaleXY = function setScaleXY(scaleX, scaleY) {
        this.scaleX = scaleX;
        this.scaleY = scaleY;
    };

    Portal.prototype.draw = function draw(ctx) {
        this.move();
...
var Cloud = function (_Element2) {
    _inherits(Cloud, _Element2);

    function Cloud(img, x, y, width, height) {
        _classCallCheck(this, Cloud);

        var _this2 = _possibleConstructorReturn(this, _Element2.call(this, x, y, width, height));

        _this2.img = new Sprite(img, 0, 0, img.width, img.height);
        _this2.speed = 1;
        _this2.isCollision = false;
        return _this2;
    }

    Cloud.prototype.setIsCollision = function setIsCollision(bool) {
        this.isCollision = bool;
    };

    Cloud.prototype.effectCollision = function effectCollision(collision) {
    ...
    Cloud.prototype.draw = function draw(ctx) {
        this.move();
...
var Skill = function (_Element3) {
    _inherits(Skill, _Element3);

    function Skill(img, x, y, width, height, distanceFall) {
        _classCallCheck(this, Skill);

        var _this3 = _possibleConstructorReturn(this, _Element3.call(this, x, y, width, height));

        _this3.img = new Sprite(img, 0, 0, img.width, img.height);
        _this3.speed = 1;
        _this3.isCollision = false;
        _this3.distanceFall = distanceFall;
        _this3.alpha = 1;
        _this3.collision = false;
        _this3.score = 1;
        return _this3;
    }

    Skill.prototype.move = function move() {
        if (this.collision) {
            this.y -= 0.5;
        } else {
    ...
    Skill.prototype.draw = function draw(ctx) {
        this.move();
        if (this.collision) {
...
var Bomb = function (_Element4) {
    _inherits(Bomb, _Element4);

    function Bomb(imgBomb, imgExplosion, x, y, width, height, distanceFall) {
        _classCallCheck(this, Bomb);

        var _this4 = _possibleConstructorReturn(this, _Element4.call(this, x, y, width, height));

        _this4.speed = 1;
        _this4.distanceFall = distanceFall;
        _this4.explode = false;
        _this4.animation = getAnimationBomb(imgBomb, imgExplosion);
        return _this4;
    }

    Bomb.prototype.move = function move() {
        if (!this.explode) {
            if (this.x < this.distanceFall) {
                this.y += this.speed;
            } else {
    ...
    Bomb.prototype.draw = function draw(ctx) {
        this.move();
        if (this.x < this.distanceFall) {
            if (this.explode) {
                this.animation.explosion.explode[this.animation.explosion.frame % 12].draw(ctx, this.x - this.animation.explosion.explode[this.animation.explosion.frame % 12].sWidth / 2 + this.width / 2, this.y - this.animation.explosion.explode[this.animation.explosion.frame % 12].sHeight / 2 + this.height / 2, this.animation.explosion.explode[this.animation.explosion.frame % 12].sWidth, this.animation.explosion.explode[this.animation.explosion.frame % 12].sHeight);
                ...
                this.animation.bomb[this.animation.frame % 3].draw(ctx, this.x, this.y, this.width, this.height);
...
function createSkillOrBomb(imgsSkill, imgBomb, imgExplosion, cloud, canvasWidth) {
    ...
    if (objRet.type == "skill") {
        var skill = new Skill(objRet.img, cloud.x + 30, cloud.y + 10, 40, 50, randomNumber(0, canvasWidth - 50));
        skill.score = score;
        ...
        var bomb = new Bomb(imgBomb, imgExplosion, cloud.x + 30, cloud.y + 10, 50, 50, randomNumber(0, canvasWidth - 50));
...
var Character = function (_Element5) {
    _inherits(Character, _Element5);

    function Character(img, x, y, width, height) {
        _classCallCheck(this, Character);

        var _this5 = _possibleConstructorReturn(this, _Element5.call(this, x, y, width, height));

        _this5.animation = getAnimationCharacter(img);
        _this5.speed = 2;
        _this5.isCollision = false;
        _this5.arrowMove = [{
            keyCode: 38,
            keyIsUp: false
        }, //up
    ...
    Character.prototype.changeImg = function changeImg(img) {
        this.animation = getAnimationCharacter(img);
    };

    Character.prototype.restartCharacter = function restartCharacter() {
    ...
    Character.prototype.effectCollision = function effectCollision(collision) {
        switch (collision.type) {
            case "canvas":
                switch (collision.direction) {
    ...
    Character.prototype.setIsCollision = function setIsCollision(bool) {
        this.isCollision = bool;
    };
    ...
    Character.prototype.move = function move() {
        ...
        this.arrowMove.map(function (item) {
            if (item.keyIsUp) {
                switch (item.keyCode) {
                    case 38:
                        //up
                    ...
                    case 37:
                        //left
                        _this6.setX(_this6.x - _this6.speed);
                        _this6.animation.direction = "left";
                        break;
                    case 39:
                        //right
                        _this6.setX(_this6.x + _this6.speed);
                        _this6.animation.direction = "right";
                        break;
                    case 16:
                        //shift
                        _this6.speed = 5;
                        _this6.animation.maxTime = 3;
                        break;
                    default:
                        return;
                }
...
var Horse = function (_Element6) {
    _inherits(Horse, _Element6);

    function Horse(img, x, y, width, height) {
        _classCallCheck(this, Horse);

        var _this7 = _possibleConstructorReturn(this, _Element6.call(this, x, y, width, height));

        _this7.animation = getAnimationHorse(img);
        _this7.speed = 0.5;
        _this7.distanceToGo = x;
        _this7.isCollision = false;
        _this7.isJumping = false;
        _this7.baseY = y;
        _this7.movementJumpUp = true;
        _this7.velocityY = 0;
        _this7.gravity = 0.5;
        _this7.maxJump = 2;
        _this7.actualJump = 0;
    ...
    Horse.prototype.setIsCollision = function setIsCollision(bool) {
        this.isCollision = bool;
    };

    Horse.prototype.effectCollision = function effectCollision(collision) {
        switch (collision.type) {
            case "canvas":
                switch (collision.direction) {
                    case "up":
    ...
    Horse.prototype.draw = function draw(ctx) {
        this.move();
        switch (this.animation.direction) {
            case "stayStill":
                this.animation.stayStill.draw(ctx, this.x, this.y, this.width, this.height);
                break;
            case "run":
                this.animation.run[this.animation.frame % 7].draw(ctx, this.x, this.y, this.width, this.height);
                if (this.animation.actualTime < this.animation.maxTime) {
                    this.animation.actualTime++;
                } else {
                    this.animation.frame++;
                ...
                break;
            case "jump":
                this.animation.jump[this.animation.frame % 7].draw(ctx, this.x, this.y, this.width, this.height);
...
var TextExperience = function (_Element7) {
    _inherits(TextExperience, _Element7);

    function TextExperience(text, x, y, width, height) {
        _classCallCheck(this, TextExperience);

        var _this8 = _possibleConstructorReturn(this, _Element7.call(this, x, y, width, height));

        _this8.text = text;
        _this8.speed = 5;
        _this8.isCollision = false;
        _this8.scaleX = 1;
        _this8.alpha = 1;
        return _this8;
    }

    TextExperience.prototype.setIsCollision = function setIsCollision(bool) {
        this.isCollision = bool;
    };

    TextExperience.prototype.effectCollision = function effectCollision(collision) {
    ...
    TextExperience.prototype.move = function move() {
        if (!this.isCollision) {
            this.x -= this.speed;
        } else {
            this.scaleX += -0.01;
    ...
    TextExperience.prototype.draw = function draw(ctx) {
        this.move();
        ctx.save();
...
function createTextExperience(ctx, canvasWidth) {
    ...
    return new TextExperience(tabText[selectedIndex], canvasWidth, randomNumber(20, 500), 300, 20);
}

var BackParallax = function (_Element8) {
    _inherits(BackParallax, _Element8);

    function BackParallax(img, x, y, width, height, speed) {
        _classCallCheck(this, BackParallax);

        var _this9 = _possibleConstructorReturn(this, _Element8.call(this, x, y, width, height));

        _this9.img = new Sprite(img, 0, 0, img.width, img.height);
        _this9.speed = speed;
        return _this9;
    }

    BackParallax.prototype.move = function move() {
        this.x -= this.speed;
    };

    BackParallax.prototype.draw = function draw(ctx, canvasWidth, canvasHeight) {
        this.move();
...
var Tile = function (_Element9) {
    _inherits(Tile, _Element9);

    function Tile(img, x, y, width, height, speed) {
        _classCallCheck(this, Tile);

        var _this10 = _possibleConstructorReturn(this, _Element9.call(this, x, y, width, height));

        _this10.img = new Sprite(img, 0, 0, img.width, img.height);
        _this10.speed = speed;
        return _this10;
    }

    Tile.prototype.move = function move() {
        this.x -= this.speed;
    };

    Tile.prototype.draw = function draw(ctx) {
        this.move();
        this.img.draw(ctx, this.x, this.y, this.width, this.height);
    };
...
var Sprite = function () {
    ...
    Sprite.prototype.draw = function draw(ctx, dx, dy, dWidth, dHeight) {
...
function getAnimationBomb(img, imgExplosion) {
    return {
        ...
        maxTime: 10,
        actualTime: 0,
        bomb: [new Sprite(img, 24, 3, 77, 107), new Sprite(img, 149, 3, 84, 109), new Sprite(img, 277, 3, 83, 112)],
...
function getAnimationExplosion(img) {
    return {
        ...
        maxTime: 3,
        actualTime: 0,
        explode: [new Sprite(img, 30, 19, 66, 76), new Sprite(img, 140, 9, 96, 109), new Sprite(img, 263, 1, 108, 121), new Sprite(img, 391, 4, 113, 119), new Sprite(img, 11, 133, 106, 115), new Sprite(img, 141, 134, 102, 114), new Sprite(img, 269, 141, 95, 97), new Sprite(img, 398, 142, 93, 92), new Sprite(img, 24, 273, 79, 88), new Sprite(img, 165, 294, 47, 53), new Sprite(img, 292, 294, 48, 52), new Sprite(img, 421, 296, 45, 49)]
    };
}
...
function loadAssets(callback) {
    var assetsSrc = {
        background: {
            forest: ["assets/background/forest/background.png", "assets/background/forest/bigClouds.png", "assets/background/forest/hill.png", "assets/background/forest/bushes.png", "assets/background/forest/distantTrees.png", "assets/background/forest/tree.png", "assets/background/forest/ground.png"],
            western: ["assets/background/western/background.png", "assets/background/western/stars.png", "assets/background/western/sun.png", "assets/background/western/mountains.png", "assets/background/western/clouds.png", "assets/background/western/layer4.png", "assets/background/western/layer3.png", "assets/background/western/layer2.png", "assets/background/western/layer1.png"]
        },
        characters: {
            rick: ["assets/character/rick.png", "assets/character/rickCowboy.png"],
            morty: ["assets/character/mortyNoEye.png", "assets/character/mortyOneEye.png", "assets/character/morty.png", "assets/character/mortyThreeEye.png", "assets/character/mortyCowboy.png"],
            horse: ["assets/character/horseSprite.png"]
        },
        effects: {
            explosion: ["assets/effects/effectExplo.png"]
        },
        elements: {
            bomb: ["assets/elements/bomb.png"],
            clouds: ["assets/elements/cloud1.png", "assets/elements/cloud2.png", "assets/elements/cloud3.png", "assets/elements/cloud4.png", "assets/elements/cloud5.png"],
            portal: ["assets/elements/element.png"],
            skills: ["assets/skills/html.png", "assets/skills/css.png", "assets/skills/js.png", "assets/skills/php.png", "assets/skills/jquery.png", "assets/skills/bootstrap.png", "assets/skills/angular.png", "assets/skills/react.png", "assets/skills/symfony.png", "assets/skills/nodejs.png", "assets/skills/mongodb.png", "assets/skills/mysql.png"]
        },
        tiles: {
            grass: ["assets/tiles/grass/tile_grass_02.png"]
        }
    };
    var assets = {
        background: {
...
var CollisionDetector = function () {
    ...
    CollisionDetector.prototype.isCollisionCoord = function isCollisionCoord(xObj1, yObj1, wObj1, hObj1, xObj2, yObj2, wObj2, hObj2) {
    ...
    CollisionDetector.prototype.isCollisionElem = function isCollisionElem(elem1, elem2) {
        if (elem1.x < elem2.x + elem2.width && elem1.x + elem1.width > elem2.x && elem1.y < elem2.y + elem2.height && elem1.height + elem1.y > elem2.y) {
            return true;
        } else {
            return false;
        }
    ...
    CollisionDetector.prototype.isOutCanvas = function isOutCanvas(elem) {
    ...
    CollisionDetector.prototype.passPortal = function passPortal(portal, character, fromLeft) {
        if (fromLeft) {
    ...
    CollisionDetector.prototype.testCollision = function testCollision() {};
    //Out canvas compared to morty


    CollisionDetector.prototype.isOutCanvasRickAndMorty = function isOutCanvasRickAndMorty(morty, rick) {
...
var Game = function () {
    function Game(objAssets, canvasWidth, canvasHeight, ctxs) {
         ...
         */
        this.characters = {
            rick: new Character(objAssets.characters.rick[0], 60, canvasHeight / 3 * 2 - 80, 60, 79),
            morty: new Character(objAssets.characters.morty[2], 0, canvasHeight / 3 * 2 - 79, 60, 79)
        };
        this.actualStage = 0;
    ...
    Game.prototype.switchStage = function switchStage() {
    ...
    Game.prototype.createStages = function createStages() {
        var stages = [];
        /////////////////////////////// STAGE 1 //////////////////////////////////////////
        var stage1FctDown = function stage1FctDown(event) {
            if (event.defaultPrevented) {
                return;
            }
            //Only allow right move and sprint
            if (event.keyCode == 39 || event.keyCode == 16) {
                var fctMap = function fctMap(elem) {
        ...
        var stage1FctUp = function stage1FctUp(event) {
            var _this11 = this;

            if (event.defaultPrevented) {
                return;
            }
            var fctMap = function fctMap(elem, character) {
                if (elem.keyCode == event.keyCode) {
            ...
            this.characters.rick.arrowMove.map(function (elem) {
                if (elem.keyCode == event.keyCode) {
                    _this11.characters.rick.animation.frame = 0;
                    _this11.characters.rick.animation.direction = "stayStill";
                    elem.keyIsUp = false;
                    if (event.keyCode == 16) {
                        _this11.characters.rick.animation.maxTime = 10;
                        _this11.characters.rick.speed = 2;
                    }
                }
            });
            this.characters.morty.arrowMove.map(function (elem) {
                if (elem.keyCode == event.keyCode) {
                    _this11.characters.morty.animation.frame = 0;
                    _this11.characters.morty.animation.direction = "stayStill";
                    elem.keyIsUp = false;
                    if (event.keyCode == 16) {
                        _this11.characters.morty.animation.maxTime = 10;
                        _this11.characters.morty.speed = 2;
                    }
                }
            });
            console.log("from1");
        ...
        var stage1 = new Stage(elemStage, [], this.characters, this.collisionDetector, stage1FctDown, stage1FctUp);
        ...
        var stage2FctDown = function stage2FctDown(event) {
            if (event.defaultPrevented) {
                return;
            }
            var fctMap = function fctMap(elem) {
        ...
        var stage2FctUp = function stage2FctUp(event) {
            var _this12 = this;
            ...
            this.characters.morty.arrowMove.map(function (elem) {
                if (elem.keyCode == event.keyCode) {
                    _this12.characters.morty.animation.frame = 0;
                    _this12.characters.morty.animation.direction = "stayStill";
                    elem.keyIsUp = false;
                    if (event.keyCode == 16) {
                        _this12.characters.morty.animation.maxTime = 10;
                        _this12.characters.morty.speed = 2;
                    }
                }
            });
            console.log("from2");
        ...
        var stage2 = new Stage(elemStage2, elemBackStage2, this.characters, this.collisionDetector, stage2FctDown, stage2FctUp);
        ...
        stage2.start = function (ctxs, canvasWidth, canvasHeight, fctStop) {
            ...
            var clouds = [];
            for (var i = 0; i < 15; i++) {
                var cloud = new Cloud(this.elemStage.clouds[randomNumber(0, this.elemStage.clouds.length - 1)], canvasWidth + randomNumber(0, canvasWidth), randomNumber(0, 150), 110, 70);
            ...
            function loopGame() {
                ...
                skills.map(function (skill, index) {
                    if (objCollision.isCollisionCoord(morty.x, morty.y, morty.width, morty.height, skill.x, skill.y, skill.width, skill.height - 35) && !skill.collision) {
                        // Collision
                        setTimeout(function () {
                ...
                bombs.map(function (bomb, index) {
                    if (objCollision.isCollisionCoord(morty.x, morty.y, morty.width, morty.height, bomb.x, bomb.y, bomb.width, bomb.height - 35) && !bomb.explode) {
                        if (scorePlayer > 0) {
                            scorePlayer -= 1;
                        }
                        bomb.explode = true;
        ...
        var stage3FctDown = function stage3FctDown(event) {
            if (event.defaultPrevented) {
                return;
            }
            //Only allow right move and sprint
        ...
        var stage3FctUp = function stage3FctUp(event) {
            var _this13 = this;
            ...
            this.characters.rick.arrowMove.map(function (elem) {
                if (elem.keyCode == event.keyCode) {
                    _this13.characters.rick.animation.frame = 0;
                    _this13.characters.rick.animation.direction = "stayStill";
                    elem.keyIsUp = false;
                    if (event.keyCode == 16) {
                        _this13.characters.rick.animation.maxTime = 10;
                        _this13.characters.rick.speed = 2;
                    }
                }
            });
            this.characters.morty.arrowMove.map(function (elem) {
                if (elem.keyCode == event.keyCode) {
                    _this13.characters.morty.animation.frame = 0;
                    _this13.characters.morty.animation.direction = "stayStill";
                    elem.keyIsUp = false;
                    if (event.keyCode == 16) {
                        _this13.characters.morty.animation.maxTime = 10;
                        _this13.characters.morty.speed = 2;
                    }
                }
            });
            console.log("from3");
        ...
        var stage3 = new Stage(elemStage3, [], this.characters, this.collisionDetector, stage3FctDown, stage3FctUp);
        ...
        ////////////////////////////////////////////////////////////////////////
        /////////////////////////STAGE 4 WESTERN/////////////////////////////////
        var stage4FctDown = function stage4FctDown(event) {
            if (event.defaultPrevented) {
                return;
            }
            if (event.keyCode == 32) {
        ...
        var stage4FctUp = function stage4FctUp(event) {
            if (event.defaultPrevented) {
                return;
            }
            event.preventDefault();
        ...
        var stage4 = new Stage(elemStage4, elemBackStage4, this.characters, this.collisionDetector, stage4FctDown, stage4FctUp);
        ...
        stage4.start = function (ctxs, canvasWidth, canvasHeight, fctStop) {
            ...
            //Create Tiles Grass
            var tilesGrass = [new Tile(this.elemBack.tilesGrass[0], 0, 530, 360, 120, 4), new Tile(this.elemBack.tilesGrass[0], 360, 530, 360, 120, 4), new Tile(this.elemBack.tilesGrass[0], 720, 530, 360, 120, 4), new Tile(this.elemBack.tilesGrass[0], 1080, 530, 360, 120, 4)];
            ...
            var cloud = {
                ...
                width: 110,
                height: 70,
                img: new Sprite(this.elemStage.cloud, 0, 0, this.elemStage.cloud.width, this.elemStage.cloud.height)
                /// Create Portal ///
        ...
        var stage5FctDown = function stage5FctDown(event) {
            if (event.defaultPrevented) {
                return;
            }
        ...
        var stage5FctUp = function stage5FctUp(event) {
            var _this14 = this;
            ...
            this.characters.rick.arrowMove.map(function (elem) {
                if (elem.keyCode == event.keyCode) {
                    _this14.characters.rick.animation.frame = 0;
                    _this14.characters.rick.animation.direction = "stayStill";
                    elem.keyIsUp = false;
                    if (event.keyCode == 16) {
                        _this14.characters.rick.animation.maxTime = 10;
                        _this14.characters.rick.speed = 2;
                    }
                }
            });
            this.characters.morty.arrowMove.map(function (elem) {
                if (elem.keyCode == event.keyCode) {
                    _this14.characters.morty.animation.frame = 0;
                    _this14.characters.morty.animation.direction = "stayStill";
                    elem.keyIsUp = false;
                    if (event.keyCode == 16) {
                        _this14.characters.morty.animation.maxTime = 10;
                        _this14.characters.morty.speed = 2;
                    }
                }
            });
        ...
        var stage5 = new Stage(elemStage5, [], this.characters, this.collisionDetector, stage5FctDown, stage5FctUp);
        ...
        stage5.start = function (ctxs, canvasWidth, canvasHeight, fctStop) {
            ...
            gradient.addColorStop("0.60", "yellow");
            gradient.addColorStop("1.0", "green");
            var tabElemnentCV = getCvPart1(canvasWidth, canvasHeight).concat(getSkillsCv(canvasWidth, canvasHeight).concat(getEndCV(canvasWidth, canvasHeight)));
            /*  drawCvPart1(ctxs.back, canvasWidth, canvasHeight);
            drawSkillsCv(ctxs.back, canvasWidth, canvasHeight); */
            window.requestAnimationFrame(loop);
...
var Stage = function () {
    function Stage(elemStage, elemBack, characters, collisionDetector, fctKeyDown, fctKeyUp) {
...
document.addEventListener("DOMContentLoaded", function () {
    function initGameClass(objAssets) {
        ...
        var game = new Game(objAssets, canvasBack.width, canvasBack.height, ctxs);
        game.startGame();
    }
